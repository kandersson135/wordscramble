$(document).ready(function() {
  const words = ['fortnite', 'roblox', 'pokemon', 'minecraft', 'mario', 'thesims', 'tetris', 'zelda', 'fallguys', 'sonic'];
  ...
  function checkWord() {
    ...
    if (userInput === currentWord) {
      ...
      if (currentLevel > words.length) {
        localStorage.setItem("ws-g18", 10);
        setTimeout(function() {
          window.location = "index.html";
        }, 800);
      } else {
        localStorage.setItem("ws-g18", currentLevel);
      }
