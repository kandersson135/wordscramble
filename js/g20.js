$(document).ready(function() {
  const words = ['februari', 'december', 'oktober', 'mars', 'september', 'januari', 'juni', 'november', 'maj', 'augusti'];
  ...
  function checkWord() {
    ...
    if (userInput === currentWord) {
      ...
      if (currentLevel > words.length) {
        localStorage.setItem("ws-g20", 10);
        setTimeout(function() {
          window.location = "index.html";
        }, 800);
      } else {
        localStorage.setItem("ws-g20", currentLevel);
      }
