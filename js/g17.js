$(document).ready(function() {
  const words = ['batman', 'superman', 'hulk', 'ironman', 'deadpool', 'thor', 'aquaman', 'hawkeye', 'supergirl', 'vision'];
  ...
  function checkWord() {
    ...
    if (userInput === currentWord) {
      ...
      if (currentLevel > words.length) {
        localStorage.setItem("ws-g17", 10);
        setTimeout(function() {
          window.location = "index.html";
        }, 800);
      } else {
        localStorage.setItem("ws-g17", currentLevel);
      }
