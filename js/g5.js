$(document).ready(function() {
  const words = ['soffa', 'matbord', 'säng', 'lampa', 'gardin', 'blomma', 'kontor', 'skrivbord', 'bokhylla', 'garderob'];
  ...
  function checkWord() {
    ...
    if (userInput === currentWord) {
      ...
      if (currentLevel > words.length) {
        localStorage.setItem("ws-g5", 10);
        setTimeout(function() {
          window.location = "index.html";
        }, 800);
      } else {
        localStorage.setItem("ws-g5", currentLevel);
      }
