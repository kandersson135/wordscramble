$(document).ready(function() {
  const words = ['fotboll', 'simning', 'basket', 'tennis', 'golf', 'boxning', 'ishockey', 'klättring', 'segling', 'brottning'];
  ...
  function checkWord() {
    ...
    if (userInput === currentWord) {
      ...
      if (currentLevel > words.length) {
        localStorage.setItem("ws-g19", 10);
        setTimeout(function() {
          window.location = "index.html";
        }, 800);
      } else {
        localStorage.setItem("ws-g19", currentLevel);
      }
