$(document).ready(function() {
  const words = ['gitarr', 'piano', 'trummor', 'flöjt', 'saxofon', 'trumpet', 'harpa', 'cello', 'banjo', 'munspel'];
  ...
  function checkWord() {
    ...
    if (userInput === currentWord) {
      ...
      if (currentLevel > words.length) {
        localStorage.setItem("ws-g13", 10);
        setTimeout(function() {
          window.location = "index.html";
        }, 800);
      } else {
        localStorage.setItem("ws-g13", currentLevel);
      }
